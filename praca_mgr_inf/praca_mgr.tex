 ...
 \chapter{Problemy na wadliwej hiperkostce}
  ...
  \section{Długie ścieżki i cykle w grafie} %TODO jeśli wyłącze podrozdziały o poziom wyżej, to trzeba zmienić wewnętrzne odniesienia typu w poprzednim podrozdziale
   ...
   \subsection{Długie pary ścieżek}
    ...
    \end{remark}
  \section{Ścieżka i cykl Hamiltona}
  ...
  \section{Inne problemy}
   \subsection{Cykl Eulera}
    ...
    \end{proof}
   \subsection{Największa odległość grafowa}%TODO sprawdzić czy zawsze nazywam tak samo współrzędne (od 0 do n-1), w innych podrozdziałach też
    ...
    (dla $n\le 6$ dokładnie, dalej przy pomocy metod losowych) wyniosły:\newline%TODO przeliczyć jeszcze raz - może da się dłuższe |sprawdzic dla 17 i dodac dla 20 
    ...
    %TODO sprobowac sprawdzic czy nie da sie opisac zbioru nieodwiedzanych przez dluga sciezke - ktory jest wielomianowy
