 ...
 \chapter{Ocena i porównanie systemów}
  ...
  \section{Jakość list rekomendacyjnych}
   ...
   \subsection{Pokrycie}
    ...
    %TODOTODO zrobić porównanie
   \section{Porównanie czasowe}
   % CF - 370s, CF item - 586s
   % CF mix - 558s, XF mix item - 877s
   % CF further - 663s,CF further item - 1188
   % CF further slow - 872s, CF further item slow 1627
   % SO 577
   % Complex - 3s zwykły, 78 - mnożenie na pałe
...
\addcontentsline{toc}{chapter}{Bibliografia}
  ...
  %TODO czy MovieLens też tutaj dać tak
