...
\addcontentsline{toc}{chapter}{Wprowadzenie}
 ...
 \chapter{Ocena i porównanie systemów}
  ...
  \section{Ewaluacja predykcji ocen}
   ...
   \begin{center}
    \includegraphics[scale=0.35]{CF_item_MAE.jpg}
   \end{center}
   \begin{center}
    \includegraphics[scale=0.35]{CF_item_MSE.jpg}
   \end{center}
   ...
   \begin{center}
    \includegraphics[scale=0.35]{MAE2.jpg}
   \end{center}
   \begin{center}
    \includegraphics[scale=0.35]{MSE2.jpg}
   \end{center}
