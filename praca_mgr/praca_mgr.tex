...
\addcontentsline{toc}{chapter}{Wprowadzenie}
 ...
 \chapter{Podstawowe techniki}
  ...
  \section{Filtrowanie kolaboratywne}%TODO napisać, że raczej explicit feedback, choć dla implicit feedback też coś się da
   ...
   %TODO napisać, że można też zamienić role użytkowników i przedmiotów - silnie zaznaczyć - slope one zakłada, że jest to wiadome
 ...
 \chapter{TODO - ulepszenia}
  \section{TODO - podsekcja o ulepszeniach o danym typie}
   \subsection{Complex}
    %TODOTODO wpisać w opisie problemu jako jeden z możliwych celów znajdowanie tylko najlepiej ocenianych przedmiotów - połączenie wyniku implicit i explicit
    ...
    (algorytmy CF i SO do wyliczenia wszystkich ocen potrzebują czasu $O(m^2n^2)$ dla macierzy o rozmiarach $m\times n$ badając tylko bardzo krótkie ścieżki,
