...
\addcontentsline{toc}{chapter}{Wprowadzenie}
 ...
 \chapter{Ocena i porównanie systemów}
  ...
  \section{Opis danych}
   ...
   (całe dane podzialone na 5 części, zbiór testowy to jedna z tych części, zaś odpowiedni treningowy to pozostałe części).
  ...
  \section{Evaluacja predykcji ocen}
...
\addcontentsline{toc}{chapter}{Bibliografia}
  ...
  \bibitem[MML]{MML} Zeno Gantner, Steffen Rendle, Lucas Drumond, and Christoph Freudenthaler
  \textit{MyMediaLite}
