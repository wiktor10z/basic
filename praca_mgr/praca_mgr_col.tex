...
\addcontentsline{toc}{chapter}{Wprowadzenie}
 ...
 \chapter{Ocena i porównanie systemów}
  ...
  \section{Ewaluacja predykcji ocen}
   ...
   \begin{center}
    \includegraphics[scale=0.35]{CF_item_MAE_color.jpg}
   \end{center}
   \begin{center}
    \includegraphics[scale=0.35]{CF_item_MSE_color.jpg}
   \end{center}
   ...
   \begin{center}
    \includegraphics[scale=0.35]{MAE2_color.jpg}
   \end{center}
   \begin{center}
    \includegraphics[scale=0.35]{MSE2_color.jpg}
   \end{center}
...
\addcontentsline{toc}{chapter}{Bibliografia}
  ...
  %TODO czy MovieLens też tutaj dać 
