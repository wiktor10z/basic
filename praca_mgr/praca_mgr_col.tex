...
\keywords{rekomendacje, predykcja ocen, systemy rekomendacyjne, filtorowanie kolaboratywne, CF, Slope One, SVD, BPR, Complex, porównanie algorytmów}
...
\tableofcontents
 ...
 \chapter{Ulepszenia}
  ...
  \section{Standardowe ulepszenia algorytmów}
   ...
   \subsection{ulepszenia CF}
    ...
    \subsubsection{dalsze podobieństwo}
     ...
     \begin{center}
      \includegraphics[scale=0.7]{img/graf1(221).jpg}
     \end{center}
    \subsubsection{połączenie ulepszeń}
     ...
     \begin{center}
      \includegraphics[scale=0.7]{img/graf2(221).jpg}
     \end{center}
  ...
  \section{Nowe algorytmy zbudowane na podstawie starych}
   ...
   \subsection{Complex}
    ...
    \begin{center}
     \includegraphics[scale=0.65]{img/graf1(191).jpg}
    \end{center}
 ...
 \chapter{Ocena i porównanie systemów}
  ...
  \section{Ewaluacja predykcji ocen}
   ...
   \begin{center}
    \includegraphics[scale=0.35]{img/CF_item_MAE_color.jpg}
   \end{center}
   \begin{center}
    \includegraphics[scale=0.35]{img/CF_item_MSE_color.jpg}
   \end{center}
   ...
   \begin{center}
    \includegraphics[scale=0.35]{img/MAE2_color.jpg}
   \end{center}
   \begin{center}
    \includegraphics[scale=0.35]{img/MSE2_color.jpg}
   \end{center}
  ...
  \section{Jakość list rekomendacyjnych}
   ...
   \subsection{Porównanie systemów}
    ...
    \includegraphics[scale=0.2]{img/ROC_all_color.jpg}
    \includegraphics[scale=0.2]{img/Prec_all_100_color.jpg}\newline
    ...
    \subsubsection{Complex}
     ...
     \includegraphics[scale=0.4]{img/Prec_Complex_exp_color.jpg}\newline
     \includegraphics[scale=0.4]{img/Prec_Complex_impl_color.jpg}\newline
     ...
     lepsze rezultaty.\newline
     \includegraphics[scale=0.2]{img/ROC_Complex_all_color.jpg}
     \includegraphics[scale=0.2]{img/ROC_Complex_best_color.jpg}\newline
    \subsubsection{BPR/MABPR}
     \includegraphics[scale=0.4]{img/Prec_BPR_color.jpg}\newline
     ...
     \includegraphics[scale=0.2]{img/ROC_BPR_color.jpg}
     \includegraphics[scale=0.2]{img/MAP_BPR_color.jpg}    
   \subsection{Pokrycie}
    ...
    \includegraphics[scale=0.2]{img/Cov_non_per_color.jpg}
    \includegraphics[scale=0.2]{img/Cov_CF_color.jpg}\newline
    \includegraphics[scale=0.2]{img/Cov_SVD_color.jpg}
    \includegraphics[scale=0.2]{img/Cov_Complex_color.jpg}\newline
    ...
    \begin{center}
    \includegraphics[scale=0.3]{img/Cov_between_color.jpg}
    \end{center}
